...
const ZIP_DEFAULT = '55016'; // Cottage Grove, MN
const ADDRESS_DEFAULT = 'Cottage Grove, MN';
...
module.exports = async function handler(req, res) {
  res.setHeader('Access-Control-Allow-Origin', 'https://commercialofficecleaningcottagegrove.com');
